      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-blue-800 font-semibold font-serif italic py-5">
              HELLO WELCOME TO MY WEBSITE
            </h1>
            <p className="mb-8 leading-relaxed text-green-600 italic font-serif">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Non
              cupiditate consectetur eaque iste, voluptatibus itaque, sint amet
              sequi animi alias suscipit quae, est impedit quos commodi quis
